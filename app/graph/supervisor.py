...
def build_interview_graph() -> StateGraph:
    ...
    workflow.set_entry_point("candidate_profile")
...
def _route_next_cycle(state: InterviewState) -> Literal["probe", "change_competency", "finish"]:
    return state.get("reflection_action", "probe")
